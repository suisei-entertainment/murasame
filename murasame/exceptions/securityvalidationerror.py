...
"""
Contains the implementation of the SecurityValidationError exception.
"""
...
class SecurityValidationError(FrameworkError):

    """Exception raised when a security rule is violated.
    ...
    def __init__(self,
                 message: str = '',
                 errorcode: ErrorCodes = ErrorCodes.SECURITY_VALIDATION_FAILED,
        ...
        """Creates a new SecurityValidationError instance.

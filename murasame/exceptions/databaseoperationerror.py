...
"""
Contains the implementation of the DatabaseOperationError exception.
"""
...
class DatabaseOperationError(FrameworkError):
    ...
    def __init__(self,
        ...
        """Creates a new DatabaseOperationError instance.

...
"""
Contains the implementation of the InvalidLicenseKey exception.
"""
...
class InvalidLicenseKeyError(FrameworkError):

    """Exception raised when an invalid license key is encountered.
    ...
    def __init__(self,
                 message: str = '',
                 errorcode: ErrorCodes = ErrorCodes.LICENSE_ERROR,
        ...
        """Creates a new InvalidLicenseKeyError instance.
